...
const CategoryPage: React.FC = () => {
  ...
  // Type safety for categoryArticles access
  const articles = category ? categoryArticles[category as keyof typeof categoryArticles] || [] : [];
  const categoryTitle = category ? categoryTitles[category as keyof typeof categoryTitles] || category : '';
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow pt-24 pb-16">
        <div className="page-container">
          <div className="mb-12">
            <h1 className="text-4xl font-display font-bold mb-4 capitalize">{categoryTitle}</h1>
